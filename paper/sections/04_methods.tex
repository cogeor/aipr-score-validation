...
returned, not a generated string.
\ifnmibuild
The overall score is a fixed weighted mean of the five dimensions (the weighting formula is
given in the Supplementary Information), with novelty and applicability weighted most and
citation least; the model does not emit the overall directly.
\else
The overall score is a fixed weighted mean of the five
dimensions,
\begin{equation}
...
the overall directly.
\fi The pipeline's product is this structured, evidence-grounded
