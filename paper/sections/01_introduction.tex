...
an AI first-pass signal, not a final human-reviewed verdict; in deployment a reviewer
reads and acts on it interactively. AIPR grades by \emph{prompting alone}: it is not
