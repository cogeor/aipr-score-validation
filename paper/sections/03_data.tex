...
earlier, fully pre-cutoff \mbox{ICLR}~2025 cohort is reserved as a future
contaminated contrast (\S\ref{sec:limits}), not used here. For each submission we
record two ground-truth signals:
