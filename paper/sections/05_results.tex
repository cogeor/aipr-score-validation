...
and weighting robustness are reported in Appendix~\ref{app:robust}; all point in the
same direction. A second-venue replication (ICLR~2025) is deferred to future work.
