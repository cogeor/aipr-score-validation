...
\begin{figure}[t]
  ...
  (stratified bootstrap, $n=\naiveN$) is annotated, its CI straddling zero. AIPR's
  AUROC is higher, but the paired gap is not statistically resolved---neither
  superiority nor equivalence is established here.
