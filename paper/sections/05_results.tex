...
\begin{figure}[t]
  ...
  subscores on hover---is available at \url{https://aipr.pub/publications\#fig-validation}.}
...
\begin{figure}[t]
  ...
  competently (a), while the observed AUROC gap is not statistically resolved
  (\aurocDiffPrel); the engineered pipeline's contribution is reliability (b) and a
