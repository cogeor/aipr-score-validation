...
split detailed in \S\ref{sec:discussion}, and the question of whether printed
identity moves the score by the separate prestige-perturbation experiment. A fully
pre-cutoff contaminated contrast and a prospective cohort are planned follow-ups
(\S\ref{sec:discussion}), not part of this analysis. Residual indirect familiarity
cannot be fully excluded retrospectively; only the prospective cohort closes it
entirely.
...
separately. A within-family contaminated contrast (a prior ICLR year) is a planned
follow-up that would address year-to-year stability only, not cross-field
generalization.
